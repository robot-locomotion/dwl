...
void HyLWholeBodyKinematics::updateJointState(Eigen::VectorXd position, Eigen::VectorXd velocity)
{
	...
	homogeneous_tf_.fr_trunk_X_LF_foot(position);
	homogeneous_tf_.fr_trunk_X_RF_foot(position);
	homogeneous_tf_.fr_trunk_X_LH_foot(position);
	homogeneous_tf_.fr_trunk_X_RH_foot(position);
